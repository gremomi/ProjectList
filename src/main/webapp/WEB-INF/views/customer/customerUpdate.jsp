...
function formsubmit() {
    ...
    var pwd = $("#custpwd").val();
    if (pwd.trim().length < 4 || pwd.trim().length > 10) {
...
<div id="joinForm" class="joinForm">
	...
	<input type="hidden" value="${sessionScope.loginId}" name="custid" />
		<table border="1" style="margin-left:auto; margin-right:auto;">
			...
			<tr>
				<th>수정할 비밀번호</th>
				<td><input type="password" id="custpwd" name="custpwd"style="width:60%;" placeholder="수정할 비밀번호를 입력하세요"></td>
			</tr>
			<tr>
				<th>이름</th>
				<td><input type="text" id="custname" name="custname" style="width:60%;" placeholder="이름을 입력하세요"></td>
			</tr>
			<tr>
				<th>EMail</th>
				<td><input type="text" id="custemail" name="custemail" style="width:60%;" placeholder="Email을 입력하세요"></td>
			</tr>
			<tr>
				<th>성별</th>
					<td>
			...
			<tr>
				...
				<td>				
					...
					<option value="10s">11~20세</option>
					<option value="20s">21~30세</option>
					<option value="30s">31~40세</option>
					<option value="40s">41~50세</option>
					<option value="50s">51~60세</option>
					<option value="60s">60세이상</option>
					</select>
				</td>
			</tr>
			<tr>
				<th>전화 번호</th>
				<td><input type="text" id="custphone" name="custphone" style="width:60%;"placeholder="010-0000-0000 형식으로 입력해주세요." /></td>
			</tr>
			<tr>
				<th>주소</th>
				<td>
					<div class="postButton">
						<input style="width: 75%; display: inline;" placeholder="우편번호" id="addr1" type="text" readonly="readonly" >
