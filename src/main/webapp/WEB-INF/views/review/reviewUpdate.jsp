	...
	<section>
		...
		<div class="col-sm-9 padding-right">
			<div class="product-details">
				<div class="col-sm-12">
				<form id="reviewForm" action="reviewUpdate" method="POST" enctype="multipart/form-data">
					<input type="hidden" name="reviewno" value="${review.reviewno}">
					<input type="hidden" name="profilephoto" value="${review.profilephoto}">
					<input type="hidden" name="reviewgrade" id="grade" value="${review.reviewgrade}">
					<input type="hidden" name="productno" id="productno" value="${review.productno}">
					<div class="col-sm-12">
						<p><b>리뷰 수정</b></p>
						<label>작성자 :</label>
						<ul>
...
<!-- 						<label>파일첨부 :</label> -->
						...
						<b>Rating: </b> 
						<div class="starRev" data-rate="${review.reviewgrade}">
...
<%-- 
	...
	<table border="1">
		...
		<tr>
			<th colspan="2">
				<input type="button" value="글등록" id="submitbutton" />
