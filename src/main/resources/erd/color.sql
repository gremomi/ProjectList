...
create table ingredientlist(
    ...
    danger varchar2(100) not null,
    productname varchar2(400) not null
);
...
ALTER TABLE cartrecord
	ADD FOREIGN KEY (selectno)
	REFERENCES cart(selectno)
	ON DELETE CASCADE
;
